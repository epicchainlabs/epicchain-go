...
import (
	...
	"github.com/epicchainlabs/epicchain-go/pkg/config/limits"
	...
	"github.com/epicchainlabs/epicchain-go/pkg/interop/native/policy"
	"github.com/epicchainlabs/epicchain-go/pkg/interop/native/roles"
...
func runNativeTestCases(t *testing.T, ctr interop.ContractMD, name string, nativeTestCases []nativeTestCase) {
	srcBuilder := bytes.NewBuffer([]byte(`package foo
		import "github.com/epicchainlabs/epicchain-go/pkg/interop/native/` + name + `"
